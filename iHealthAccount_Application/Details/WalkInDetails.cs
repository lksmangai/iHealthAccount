...
{
    public partial class WalkInDetails : Form
    {
        public WalkInDetails()
        {
            InitializeComponent();
            InitializeIcon();
            InitScreenData();
        ...
        private void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            //Logger.WriteTrace("WalkInDetails [Add new Procedure]", "User : " + SessionParameters.UserName + Environment.NewLine + "Item Id: " + itemId.ToString() + Environment.NewLine + "Description : " + textBoxProcName.Text.Trim() + Environment.NewLine + "Price : " + textBoxAmount.Text.Trim());
        ...
        private void buttonUpdate_Click(object sender, EventArgs e)
        {
            ...
            //Logger.WriteTrace("WalkInDetails [Update Expense]", "User : " + SessionParameters.UserName + Environment.NewLine + "Expense Id : " + procId + Environment.NewLine + "Description : " + textBoxProcName.Text.Trim() + Environment.NewLine + "Price : " + textBoxAmount.Text.Trim());
        ...
        private void buttonDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                //Logger.WriteTrace("WalkInDetails [Delete Expense]", "User : " + SessionParameters.UserName + Environment.NewLine + "Expense Id : " + procId);
