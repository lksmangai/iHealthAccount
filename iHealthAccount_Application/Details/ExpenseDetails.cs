...
namespace iHealthAccount.Application.Details
{
    public partial class ExpenseDetails : Form
    {
        ...
        {
            dataGridViewExp.DataSource = homeRecptReport.HomeReciptDetails();
        ...
        private void dataGridViewExp_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            recptByUserID = DataFormat.GetInteger(dataGridViewExp.SelectedRows[0].Cells["UserId"].Value.ToString());
